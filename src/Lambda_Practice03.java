...
public class Lambda_Practice03 {
    public static void main(String[] args) {
        ...
        System.out.println(kat2denFazlaOlanlar(kiralikDaireler));
    ...
    public static List<Integer> kat2denFazlaOlanlar( List<Apartman>  list){
      return   list.stream().filter(t-> t.getKatSayis()>2).map(t-> t.getKira()).collect(Collectors.toList());
    }
